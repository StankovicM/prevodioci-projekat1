...
class Interpreter():
    ...
    def bool(self):
        ...
        if self.current_token.type in (LESS, GREATHER, EQUAL, NOT_EQUAL, LESS_EQ, GREATHER_EQ):
            right = None
            while self.current_token.type in (LESS, GREATHER, EQUAL, NOT_EQUAL, LESS_EQ, GREATHER_EQ):
                if self.current_token.type == LESS:
                    ...
                    if not (left < right):
                         result = False
                    left = right
                elif self.current_token.type == GREATHER:
                    self.eat(GREATHER)
                    right = self.expr()
                    if not (left > right):
                         result = False
                    ...
                    if not (left <= right):
                         result = False
                    left = right
                elif self.current_token.type == GREATHER_EQ:
